...
ALTER TABLE public.app_settings
  ...
  ALTER COLUMN application_email_body SET DEFAULT E'Hallo {{vorname}} {{nachname}},\n\nvielen Dank für deine Bewerbung bei Sekretariat24.\n\nWir haben deine Unterlagen erhalten und prüfen sie sorgfältig. In Kürze melden wir uns persönlich bei dir zurück.\n\nMit freundlichen Grüßen\nDein Team von Sekretariat24';

ALTER TABLE public.applications ADD COLUMN IF NOT EXISTS ranking text;
ALTER TABLE public.applications ADD COLUMN IF NOT EXISTS booking_token uuid UNIQUE;
